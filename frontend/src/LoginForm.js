...
export default function LoginForm() {
    ...
    const handleSubmit = async event => {
        ...
        try {
            const url =
                userRole === 'Donor'
                    ? 'http://ec2-15-207-165-21.ap-south-1.compute.amazonaws.com:4000/api/donor/login'
                    : userRole === 'Recipient'
                        ? 'http://ec2-15-207-165-21.ap-south-1.compute.amazonaws.com:4000/api/recipient/login'
                        : userRole === 'Admin'
                            ? 'http://ec2-15-207-165-21.ap-south-1.compute.amazonaws.com:4000/api/admin/login'
                            : '';
