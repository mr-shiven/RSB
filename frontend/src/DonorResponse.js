...
export default function DonorResponse() {
  ...
  function checkDonationStatus() {
    axios.get('http://ec2-15-207-165-21.ap-south-1.compute.amazonaws.com:4000/check-donation-status', { params: { donationId } })
      .then(response => {
  ...
  function handleAccept() {
    ...
    axios.put('http://ec2-15-207-165-21.ap-south-1.compute.amazonaws.com:4000/donation-accepted', { donationId, email })
      .then(response => {
